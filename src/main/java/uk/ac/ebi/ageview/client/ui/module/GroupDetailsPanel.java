...
import uk.ac.ebi.ageview.client.ui.SampleListGrid;
import uk.ac.ebi.ageview.client.ui.SourceIconBundle;
import uk.ac.ebi.ageview.client.ui.test.ObjectViewer;
...
//  WaitWindow.showWait();
  ...
  AgeViewGWTService.Util.getInstance().getSamplesByGroupAndQuery(groupID, null, searchAtNames, searchAtValues,(pNum-1)*ResultPane.MAX_SAMPLES_PER_PAGE, ResultPane.MAX_SAMPLES_PER_PAGE,
...
//    });
 ...
 private void showMatchedSamples( final int pNum )
 {
  ...
  WaitWindow.showWait();
  AgeViewGWTService.Util.getInstance().getSamplesByGroupAndQuery(groupID, query, searchAtNames, searchAtValues,(pNum-1)*ResultPane.MAX_SAMPLES_PER_PAGE, ResultPane.MAX_SAMPLES_PER_PAGE,
